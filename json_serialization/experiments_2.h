...
//}
//template<typename target_t, typename writer_t>
//inline bool default_write(
//	writer_t& writer_,
//	target_t const& target_,
//	default_value_handler<target_t>* _default_h
//) const { // returns true if default writer wrote
//	return (
//		_default_h &&
//		_default_h->write(target_, writer_));
//}
...
struct af_rjson_writer_wrapper_impl_t {
	...
	bool Key(const char_t * str, size_t length, bool copy) override { return _writer.Key(str, length, copy); }		virtual bool EndObject(size_t memberCount) = 0
