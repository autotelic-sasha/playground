	...
	namespace serialization {
		...
		namespace util {
			namespace predicates {
				...
				template<typename target_t>
				using is_serializable_object_t = has_static_type_description_t<target_t>;
				template<typename T>
				...
				template<typename T>
				using if_static_serializable_t = if_t<
					all_of_t<	
						not_t<has_object_description_t<T>>,
						is_serializable_object_t<T>
					>
				>;
		...
		// a single public static functions:
		//
