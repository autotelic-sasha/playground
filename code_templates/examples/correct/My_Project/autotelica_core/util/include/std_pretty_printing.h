...
/*
            // forward declaration to make recursive calls work
            template< typename ContainerT, typename ConfigT,
                std::enable_if_t<
                is_container_t<ContainerT>::value &&
                !is_string_t<ContainerT>::value &&
                !is_adaptor_t<ContainerT>::value, int>>
            ...
            std::ostream& pretty_print_container(std::ostream& os, const ContainerT& container) { 
...
/*
            ...
            template< typename ContainerT, typename ConfigT,
                std::enable_if_t<
                    is_indexable_t<ContainerT>::value &&
                    !is_string_t<ContainerT>::value &&
                    !is_value_grid_t<ContainerT>::value, int> >
