#pragma once
#include "af_xloper_macros_function_wrapers.h"

// many parts of this are relying on https://www.wiley.com/en-gb/Financial+Applications+using+Excel+Add-in+Development+in+C+%2F+C%2B%2B%2C+2nd+Edition-p-9780470319048
