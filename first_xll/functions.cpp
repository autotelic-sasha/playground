...
//	AF_DECLARE_XLL("Autotelica Testing");
	...
	autotelica::xloper::xl_util::xl_fast_array big_array(double v) {
		autotelica::xloper::xl_util::xl_fast_array ret(100, 100, v);
		return ret;
	}
	...
	autotelica::xloper::xl_util::xl_fast_array big_array_add(double v, autotelica::xloper::xl_util::xl_fast_array in) {
		if (in.empty())
			return in;
